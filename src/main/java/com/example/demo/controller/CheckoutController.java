...
public class CheckoutController {
	...
	//payment verification to check payment is not tampered
	 ...
	 public ResponseEntity<String> markPaymentFailed(@RequestBody Map<String, String> payload,HttpSession session) {
	     NewUserModel user=getCurrentUserId();
		 if(user==null) {
			 return ResponseEntity.badRequest().body("User not found");
		 }
	     ...
	     orderService.placeFailedPayment( user,PaymentType.RazorPay,coupon);
