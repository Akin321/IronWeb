...
public class CouponDto {
    ...
    private int id;
	 @NotNull(message = "Coupon code cannot be null")
	    ...
	    @FutureOrPresent(message = "Expiry date cannot be in the future")
	...
	public CouponDto(int id,
			...
			@NotNull(message = "Expiry date cannot be null") @PastOrPresent(message = "Expiry date cannot be in the future") LocalDate expiryDate,
			@Min(value = 1, message = "Minimum usage must be 1") @NotNull int total_usage,
			@Min(value = 1, message = "Minimum usage must be 1") Integer perUserLimit,
			@Min(value = 1, message = "Minimum usage must be 1") Integer totalUsageLimit,
